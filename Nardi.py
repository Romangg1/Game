...
class GameWindow:
    def __init__(self, root):
        ...
        # Создаем места для отображения фишек игроков
    ...
    def create_score_labels(self):
        ...
        self.player1_score_label = tk.Label(self.game_window, text='белый', bg='white')
        ...
        self.player2_score_label = tk.Label(self.game_window, text='чёрный', bg='white')
