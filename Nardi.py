...
class GameWindow:
    def __init__(self, root):
        ...
        self.dice_label1.grid(row=6, column=2)

        self.dice_label2 = tk.Label(self.game_window, image=self.dice_images[0])
        self.dice_label2.grid(row=6, column=3)
        ...
        self.game_field.grid(row=0, column=2, rowspan=6, columnspan=2)
    ...
    def create_score_labels(self):
        self.player1_label = tk.Label(self.game_window, text='Игрок1', fg='blue', bg='white')
    ...
    def roll_dice(self):
        ...
        if dice1 == dice2:
            self.turn.set(f'Игрок {self.current_player}, \nкубики: {dice1}, {dice2}, {dice2}, {dice2}')
        else:
            self.turn.set(f'Игрок {self.current_player}, \nкубики: {dice1}, {dice2}')
